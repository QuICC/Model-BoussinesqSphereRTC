...
import quicc_solver.model.boussinesq.sphere.rtc.implicit.physical_model as mod
...
bc_vel = 0; bc_temp = 0; Pr = 1
E = 1.7e-3; Rac = 91.6877*1.03
res = [32, 32, 0]
#E = (1.0/1e6)**0.5
#res = [32, 32, 0]
#E = (1.0/1e7)**0.5
...
if mc is None:
    m = np.int_(0.3029*E**(-2./6.)) # Asymptotic prediction for minimum
else:
    m = mc
if Rac is None:
...
eq_params = {'ekman':E, 'prandtl':Pr, 'rayleigh':Ra}
...
marginal_options['curve_points'] = np.arange(max(1, m-2), m+20, 1)
