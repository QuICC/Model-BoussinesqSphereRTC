...
#include "QuICC/Model/ConfigFactory.hpp"
...
int run()
{
   ...
   typedef model_ns::Explicit::PhysicalModel<model_ns::IRTCModel> Model;
   int status = QuICC::run_application<QuICC::ConfigFactory,Model>();
