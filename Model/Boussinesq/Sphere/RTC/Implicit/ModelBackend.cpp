                             ...
                             FieldComponents::Spectral::POL))
        {
                                  ...
                                  const NonDimensional::NdMap& nds)
            {
                ...
                if (l > 0)
                {
                    ...
                    bMat =
                       -static_cast<MHDFloat>(norm * T * invlapl) * corQm.mat();
                }
                                  ...
                                  const NonDimensional::NdMap& nds)
            {
                ...
                if (l > 0)
                {
                    ...
                    bMat =
                       -static_cast<MHDFloat>(norm * T * invlapl) * corQp.mat();
                }
                             ...
                             FieldComponents::Spectral::SCALAR))
        {
                             ...
                             const NonDimensional::NdMap& nds)
            {
                ...
                if (l > 0)
                {
                    ...
                    const auto Ra = nds.find(NonDimensional::Rayleigh::id())
                                       ->second->value();
                    const auto T =
                       1.0 /
                       nds.find(NonDimensional::Ekman::id())->second->value();
                    ...
                    SparseSM::Worland::I4 i4(nNr, nNc, o.a, o.b, l,
                       2 * o.truncateQI);
                    bMat = -forcing * i4.mat();
                }
