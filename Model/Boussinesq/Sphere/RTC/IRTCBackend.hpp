...
+          * @fId  Field ID
     ...
     * @param nds     Nondimensional parameters
     */
    void applyGalerkinStencil(SparseMatrix& decMat,
    ...
    void buildBlock(DecoupledZSparse& decMat,
       ...
       const int l0, const int maxL, const BcMap& bcs,
    ...
    void addBlock(SparseMatrix& mat, const SparseMatrix& block,
       const int rowShift, const int colShift,
       const MHDFloat coeff = 1.0) const;
    ...
    details::SystemInfo systemInfo(const SpectralFieldId& colId,
       const SpectralFieldId& rowId, const int l0, const int maxL,
