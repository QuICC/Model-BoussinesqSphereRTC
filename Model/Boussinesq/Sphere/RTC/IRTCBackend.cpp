...
namespace RTC {
   ...
   void IRTCBackend::addBlock(SparseMatrix& mat, const SparseMatrix& block, const int rowShift, const int colShift, const MHDFloat coeff) const
   {
   ...
   int IRTCBackend::blockSize(const SpectralFieldId& fId, const int l0, const int maxL, const Resolution& res, const BcMap& bcs, const bool isGalerkin) const
   {
      // Compute size
      auto s = 0;
   ...
   std::pair<int, int> IRTCBackend::blockShape(const SpectralFieldId& rowId, const SpectralFieldId& colId, const int l0, const int maxL, const Resolution& res, const BcMap& bcs, const bool isGalerkin, const bool dropRows) const
   {
      // Compute number of rows
      auto rows = this->blockSize(rowId, l0, maxL, res, bcs, isGalerkin || dropRows);
   ...
   details::SystemInfo IRTCBackend::systemInfo(const SpectralFieldId& rowId, const SpectralFieldId& colId, const int l0, const int maxL, const Resolution& res, const BcMap& bcs, const bool isGalerkin, const bool dropRows) const
   {
      auto shape = this->blockShape(rowId, colId, l0, maxL, res, bcs, isGalerkin, dropRows);
